...
SUPERPROXY_REQUEST_HEADERS = {
    ...
    'proxy_success_response': (ResponseMatch._list_from_superproxy_header,
                               ResponseMatch._list_to_superproxy_header),
    'proxy_success_timeout': (int, str),
    'proxy_fail_response': (ResponseMatch._list_from_superproxy_header,
                            ResponseMatch._list_to_superproxy_header),
    'proxy_fail_timeout': (int, str),
    'proxy_rest_response': (ResponseMatch._list_from_superproxy_header,
                            ResponseMatch._list_to_superproxy_header),
